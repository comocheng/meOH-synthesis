...
database_src = "/home/blais.ch/_02_RMG_envs/meoh_h2_rmg/RMG-database/"
...
N = 20
for i in range(0, N):
    database_dest = "/home/blais.ch/_02_RMG_envs/meoh_h2_rmg/db_" + str(i).zfill(4)
    ...
    copytree_sym(
        ...
        hardcopy=hardcopy_patterns(
            ...
            'surfaceThermoCu111_[0-9][0-9][0-9][0-9].py',
        )
    )
